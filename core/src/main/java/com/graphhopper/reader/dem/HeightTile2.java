...
public class HeightTile2 {
    ...
    public HeightTile2(double minLat, double minLon, int width, int height, double precision, double horizontalDegree, double verticalDegree) {
        this.minLat = minLat;
        this.minLon = minLon;
        this.width = width;
        this.height = height;
    ...
    public HeightTile2 setInterpolate(boolean interpolate) {
    ...
    public HeightTile2 setSeaLevel(boolean b) {
