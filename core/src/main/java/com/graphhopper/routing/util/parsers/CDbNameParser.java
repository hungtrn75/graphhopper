...
public class CDbNameParser implements TagParser {

  private final IntEncodedValue dbNameEnc;

  public CDbNameParser(IntEncodedValue dbNameEnc) {
  ...
  public IntsRef handleWayTags(IntsRef edgeFlags, ReaderWay readerWay, IntsRef relationFlags) {
    int osmId = 1;
    if (readerWay.hasTag(CDbName.KEY)) {
      String value = readerWay.getTag(CDbName.KEY);
